    ...
    <div className="manage-page">
      ...
      <div className="card" style={{ marginBottom: 24 }}>
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          <button className="btn-primary" onClick={submit}>{editId ? 'Lưu' : 'Thêm Page'}</button>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12, flexWrap: 'wrap' }}>
              <div style={{ minWidth: 0 }}>
                <div style={{ fontWeight: 700, display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
                  {p.name}
                  <span className="badge" style={{ background: p.has_cookies ? '#dcfce7' : '#fee2e2', color: p.has_cookies ? '#166534' : '#991b1b' }}>
